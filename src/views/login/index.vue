<template>
  <div class="login">
    ...
    <el-card class="login-card">
      ...
      <el-form ref="myForm" style="margin-top:28px" :model="loginForm" :rules="loginRules">
        <!-- 表单域  el-from-item => 行  ==》校验==》 prop==》 要检验的字段名-->
...
<style lang="less" scoped>
  .login {
     background-image: url('../../assets/img/ClBXvAKPxR.jpg');
